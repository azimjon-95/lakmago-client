...
export const PHOTO_STYLES: Record<string, { grad: string; icon: string; iconColor: string }> = {
...
export function DishPhoto({ dish, height = 96, radius = 12, iconSize = 34 }: DishPhotoProps) {
...
export function RestaurantBanner({ restaurant, height = 150 }: RestaurantBannerProps) {
